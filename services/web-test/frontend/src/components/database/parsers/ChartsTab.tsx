  ...
  return (
    <div className="space-y-6">
      ...
      <Section
        ...
        hint="Доля вызовов каждого парсера за выбранный период. В норме нагрузка распределена равномерно по 6 источникам. avg рез. = 0 при большом числе вызовов — признак тихих сбоев: парсер отвечает успешно, но возвращает 0 товаров (сайт магазина изменился)."
      >
