...
class TestProcess:
    @pytest.mark.parametrize("raw,expected", [
        ...
        # Порядковые слова — реальный кейс WB/Avito
        ("Великий западный путь второе издание", "Великий западный путь"),
        ("Каркассон первое издание", "Каркассон"),
        ("Брасс третья редакция", "Брасс"),
        # «база»/«base» как отдельное слово (false-negative из reassess #2)
        ('В поисках Эльдорадо (база)', "В поисках Эльдорадо"),
        ("В поисках Эльдорадо база", "В поисках Эльдорадо"),
        ("В поисках Эльдорадо базы", "В поисках Эльдорадо"),
        ("Catan (base)", "Catan"),
        ("Catan base", "Catan"),
        # Не должны цеплять «база» в середине (часть другого слова или
        # самостоятельная игра «База-2042» и т.п.)
        ("База данных игр", "База данных игр"),
        ("Военная база Альфа", "Военная база Альфа"),
